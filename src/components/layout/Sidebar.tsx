...
export function Sidebar() {
  ...
  const navItems = [
    { icon: '/images/icons/overview_icon.png', label: 'Overview', description: 'Dashboard overview of your progress', active: true },
    { icon: '/images/icons/subject_icon.png', label: 'Subject', description: 'Browse subjects and topics' },
    { icon: '/images/icons/test_icon.png', label: 'Test', description: 'Practice tests and assessments' },
    { icon: '/images/icons/report_icon.png', label: 'Report', description: 'View performance analytics' },
    { icon: '/images/icons/class_icon.png', label: 'Class', description: 'Access your classroom' }
  ];
  ...
  return (
    <TooltipProvider>
      ...
      >
        ...
        >
          <img
            src="/images/icons/brainbox_logo.png"
