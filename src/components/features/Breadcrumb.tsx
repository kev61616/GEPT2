...
function ToolsBar({ className }: { className?: string }) {
  ...
  const { balancePanels, toggleBalancePanels } = useLayoutSettings();
      ...
      <Tooltip delayDuration={0}>
        <TooltipTrigger asChild>
          <Button 
            ...
            className={cn(
              "h-9 w-9",
              balancePanels && "bg-blue-50 border-blue-200 text-blue-600"
            )}
            onClick={toggleBalancePanels}
            aria-label="Toggle panel height balancing"
            aria-pressed={balancePanels}
          >
        ...
        <TooltipContent className="z-[100]">
          {balancePanels 
            ? "Disable panel height balancing" 
            : "Enable panel height balancing (desktop only)"}
        </TooltipContent>
      </Tooltip>
      <Tooltip delayDuration={0}>
        <TooltipTrigger asChild>
